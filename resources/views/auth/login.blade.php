...
<head>
    ...
    <link href="{{ asset('backend/docs/css/modern.css') }}" rel="stylesheet"> 
				...
				<div id="carouselExampleIndicators" class="carousel slide carousel-fade" data-ride="carousel">
					...
					<div class="carousel-inner ">
					  <div class="carousel-item fade">
						<img class="d-block w-100" src="{{asset('images/carousel/7.jpg')}}" data-color="lightblue" alt="First Image">
					  </div>
					  <div class="carousel-item fade">
					  ...
					  <div class="carousel-item fade">
						<img class="d-block w-100" src="{{asset('images/carousel/5.jpg')}}" data-color="violet" alt="Third Image">
					  </div>
					  <div class="carousel-item fade">
						<img class="d-block w-100" src="{{asset('images/carousel/1.jpg')}}" data-color="violet" alt="Third Image">
					  </div>
					  <div class="carousel-item fade">
						<img class="d-block w-100" src="{{asset('images/carousel/8.jpg')}}" data-color="violet" alt="Third Image">
					  </div>
					  <div class="carousel-item fade">
						<img class="d-block w-100" src="{{asset('images/carousel/9.jpg')}}" data-color="violet" alt="Third Image">
					  </div>
					</div>
				  </div>
			</div>
